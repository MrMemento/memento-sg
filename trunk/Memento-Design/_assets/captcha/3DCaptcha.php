...
if (isset($_GET['id']))
{
	$cTexts			= preg_split('/\n/', file_get_contents('words.txt'), -1, PREG_SPLIT_NO_EMPTY);
	$captchaText	= strtoupper($cTexts[$_GET['id']]);
}
else
{
	$captchaText = 'DEMO';
...
$bgcolor = imagecolorallocate($image3d, 255, 255, 255);
$fgcolor = imagecolorallocate($image3d, 0, 0, 0);
